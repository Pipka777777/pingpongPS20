...
class Player(GameSprite):
    ...
    def keyProcessing(self):
        ...
        if self.rect.y > (maxX - self.rect.height):
            self.rect.y = (maxX - self.rect.height)
        elif self.rect.y < 0:
            self.rect.y = 0
...
victoryL = font_.render('YOU 1 WON', True, (255, 0, 0))###
victoryR = font_.render('YOU 2 WON', True, (255, 0, 0))
gameRes = 0
while game:
    if gameRes == 0:
        mw.fill(bgColor)
